...
import { PreviewWrapper, Seperator } from '../../styles/commons';
/* eslint-disable react/prefer-stateless-function */
class CatalogPreview extends React.PureComponent {
  render() {
    const panels = [
      {
        key: 'what-is-dog',
    ...
    return (
      <PreviewWrapper>
        <Header as="h4">Otc personal care & baby supplies</Header>
        <Seperator />
        <Header as="h4">Otc personal care & baby supplies</Header>
